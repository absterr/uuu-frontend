    ...
    <>
      <header className="border-b border-foreground/10 pb-4">
        <div className="flex flex-col gap-1">
          {/* Hid just the span text as the header element has a feature in it */}
          <span className="hidden lg:block font-mono text-[10px] uppercase tracking-wider text-foreground/40">
            Teams
          </span>
